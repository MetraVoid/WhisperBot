...
async def repos(event):
    await event.reply(
            REPO_TEXT,
            buttons=[
                [Button.url("Click Here", "https://github.com/Akira-OP/WhisperBot")]
                ]
            )
...
null_txt = 'By github.com/Akira-OP | t.me/Godfatherakira\n'
null_txt += 'Any questions? Say it at t.me/MetraVoid_Support\n'
null_txt += f'{NULLBOT_NAME} started! Developed and Maintaned by Akira\n'
print(null_txt)
